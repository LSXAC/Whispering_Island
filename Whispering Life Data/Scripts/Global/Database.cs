...
public partial class Database : Node
{
    ...
    public static Dictionary<string, Building_Menu_List_Child_Object_Info> buildings =
        new Dictionary<string, Building_Menu_List_Child_Object_Info>()
        {
            {
                BUILDING_ID.BELT.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Belt.tres"
                )
            },
            {
                BUILDING_ID.BELTTUNNEL.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Belt_Tunnel.tres"
                )
            },
            {
                BUILDING_ID.CHEST.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Chest.tres"
                )
            },
            {
                BUILDING_ID.FURNACE.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Furnace.tres"
                )
            },
            {
            ...
            },
            {
                ...
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Wooden_Bed.tres"
                )
            },
            {
                BUILDING_ID.TRASHCAN.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Trashcan.tres"
                )
            },
            {
            ...
            },
            {
                ...
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Stone_Object.tres"
                )
            },
            {
            ...
            },
            {
                ...
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Sand_Object.tres"
                )
            },
            {
            ...
            },
            {
                ...
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Chest_Puffer.tres"
                )
            },
            {
                BUILDING_ID.RAIL.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Rail.tres"
                )
            },
            {
                BUILDING_ID.RAIL_STATION.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Rail_Station.tres"
                )
            },
            {
                BUILDING_ID.MINECART.ToString(),
                ResourceLoader.Load<Building_Menu_List_Child_Object_Info>(
                    "res://Buildings/Minecart.tres"
                )
            },
        };
    ...
    public static Building_Menu_List_Child_Object_Info GetBuildingMenuListChildObjectInfo(
